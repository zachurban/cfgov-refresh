...
def assemble_output():
    ...
    for answer in answers:
        ...
        for page in answer_pages:
            if page['answer_base__id'] == answer['id'] and page['language'] == 'en':
            ...
            elif page['answer_base__id'] == answer['id'] and page['language'] == 'es':
                output['SpanishQuestion'] = page['question'].replace('\x81', '')
