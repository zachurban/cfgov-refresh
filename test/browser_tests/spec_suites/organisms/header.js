...
describe( 'Header', function() {
  ...
  if ( browser.params.windowWidth > breakpointsConfig.bpLG.min ) {
    ...
    describe( 'small size', function() {
      ...
      describe( 'click mega menu and click search', function() {
        it( 'should hide the mega menu and show search', function() {
          browser.driver.actions().click( _dom.megaMenuTrigger ).perform()
            .then( function(){
              browser.driver.actions().click( _dom.globalSearchTrigger )
                .perform().then( function() {
                  browser.driver.findElement( by.css( MEGA_MENU_CONTENT_SEL ) )
                    .then( function( elem ) {
                      browser.wait(
                        protractor.until.elementIsNotVisible( elem )
                      ).then( function() {
                        expect( _dom.megaMenuTrigger.isDisplayed() ).toBe( false );
                        expect( _dom.globalSearchTrigger.isDisplayed() ).toBe( true );
                      } );
                    } );
                } );
            } );
      ...
      // describe( 'click search and click mega menu', function() {} );
      describe( 'click search and click mega menu', function() {
        xit( 'should hide the search and show mega menu', function() {
          // TODO: Implement test.
        } );
      } );
    } );
